    ...
    static getTemplate() {
        return `
            <div class="holder">
                ...
                <path d="M20.5708 14.1425C21.2182 14.5309 21.2182 15.4691 20.5708 15.8575L13.5145 20.0913C12.848 20.4912 12 20.0111 12 19.2338L12 10.7662C12 9.9889 12.848 9.50878 13.5145 9.9087L20.5708 14.1425Z" fill="white"/>
                </svg>
            ...
            <div class="download">
                ...
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" r="15" fill="#43D14F"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M13.5 9.5C13.5 8.67157 14.1716 8 15 8C15.8284 8 16.5 8.67157 16.5 9.5V16.2785L16.7177 16.0609C17.3035 15.4751 18.2532 15.4751 18.839 16.0609C19.4248 16.6467 19.4248 17.5964 18.839 18.1822L16.0106 21.0106C15.4248 21.5964 14.475 21.5964 13.8893 21.0106C13.8861 21.0075 13.883 21.0044 13.8799 21.0012L11.0607 18.182C10.4749 17.5962 10.4749 16.6464 11.0607 16.0607C11.6465 15.4749 12.5962 15.4749 13.182 16.0607L13.5 16.3787V9.5Z" fill="white"/>
                </svg>                
                </a>
            </div>
        `;
