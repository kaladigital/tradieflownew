            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 figure-col">
                        <figure class="figure">
                            <img src="{{ $app_cdn_url }}/images/industries-page-hero-bg.png" alt="Section thumb" class="figure-img">
                        </figure>
                    </div>
                    <div class="col-12 col-md-6 content-col">
                        <h1>Save Time, Drive Sales, and Grow Your Business with All-in-One <span class="green-text">Tradie Software</span></h1>
...
{{--                    <div class="col-12 col-md-6 figure-col">--}}
{{--                        <figure class="figure">--}}
{{--                            <img class="lazyload" data-src="{{ $app_cdn_url }}/images/about-thumb.png" alt="Section thumb" class="figure-img">--}}
{{--                        </figure>--}}
{{--                    </div>--}}
{{--                    <div class="col-12 col-md-6 content-col">--}}
...
{{--                                                        <figure class="figure">--}}
{{--                                                            <img data-src="{{ $app_cdn_url }}/images/features-thumb/feature-thumb1.png" alt="Figure thumb" class="figure-img lazyload">--}}
{{--                                                        </figure>--}}
{{--                                                    </div>--}}
...
{{--                                                    <div class="col-12 col-lg-7 figure-col">--}}
{{--                                                        <figure class="figure">--}}
{{--                                                            <img data-src="{{ $app_cdn_url }}/images/features-thumb/feature-thumb2.png" alt="Figure thumb" class="figure-img lazyload">--}}
{{--                                                        </figure>--}}
{{--                                                    </div>--}}
{{--                                                    <div class="col-12 col-lg-5 mt-3 mt-md-4 mt-lg-0 content-col">--}}
...
{{--                                                    <div class="col-12 col-lg-7 figure-col">--}}
{{--                                                        <figure class="figure">--}}
{{--                                                            <img data-src="{{ $app_cdn_url }}/images/features-thumb/feature-thumb3.png" alt="Figure thumb" class="figure-img lazyload">--}}
{{--                                                        </figure>--}}
{{--                                                    </div>--}}
{{--                                                    <div class="col-12 col-lg-5 mt-3 mt-md-4 mt-lg-0 content-col">--}}
{{--                                                        <h3>Book Jobs</h3>--}}
...
{{--                                                    <div class="col-12 col-lg-7 figure-col">--}}
{{--                                                        <figure class="figure">--}}
{{--                                                            <img data-src="{{ $app_cdn_url }}/images/features-thumb/feature-thumb4.png" alt="Figure thumb" class="figure-img lazyload">--}}
{{--                                                        </figure>--}}
{{--                                                    </div>--}}
{{--                                                    <div class="col-12 col-lg-5 mt-3 mt-md-4 mt-lg-0 content-col">--}}
{{--                                                        <h3>Send Invoices</h3>--}}
...
{{--                                                    <div class="col-12 col-lg-7 figure-col">--}}
{{--                                                        <figure class="figure">--}}
{{--                                                            <img data-src="{{ $app_cdn_url }}/images/features-thumb/feature-thumb5.png" alt="Figure thumb" class="figure-img lazyload">--}}
{{--                                                        </figure>--}}
{{--                                                    </div>--}}
{{--                                                    <div class="col-12 col-lg-5 mt-3 mt-md-4 mt-lg-0 content-col">--}}
...
{{--                                                    <div class="col-12 col-lg-7 figure-col">--}}
{{--                                                        <figure class="figure">--}}
{{--                                                            <img data-src="{{ $app_cdn_url }}/images/features-thumb/feature-thumb6.png" alt="Figure thumb" class="figure-img lazyload">--}}
{{--                                                        </figure>--}}
{{--                                                    </div>--}}
{{--                                                    <div class="col-12 col-lg-5 mt-3 mt-md-4 mt-lg-0 content-col">--}}
{{--                                                        <h3>Get Reviews</h3>--}}
