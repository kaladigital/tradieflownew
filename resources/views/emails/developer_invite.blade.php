...
<head>
    ...
    <title>Developer Email template 1</title>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding:0;padding-top: 32px; text-align: center;">
                                    <h1 style="margin:0;padding:0;font-family:'Poppins', sans-serif;font-size: 30px; line-height: 36px; font-weight: 500;">
                                        ...
                                        asked you to set up TradieFlow.
                                    </h1>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding:0;padding-top: 16px; padding-bottom: 32px; font-size: 17px; line-height: 24px;">
                                    <p style="margin:0;padding:0;font-family:'Poppins', sans-serif;">
                                        You where asked add a couple of scripts to {{ $other_parameters['CLIENT_NAME'] }}'s website so they can make the most out of TradieFlow
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: center">
                                    <a href="{{ $other_parameters['URL'] }}" style="display: block; margin-left: auto; margin-right: auto; font-size: 16px; font-weight: 600;font-family:'Poppins', sans-serif; text-decoration: none !important; border-radius: 4px; max-width: 258px;">
                            ...
                            <tr>
                                <td style="padding-top: 32px; font-size: 17px; line-height: 24px;">
                                    <p style="margin:0;padding:0;font-family:'Poppins', sans-serif;">Questions about setting up TradieFlow? Get in touch with us at <a href="{{ $other_parameters['APP_URL'] }}/contact-us">www.tradieflow.co/contact-us</a></p>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-top: 40px; font-size: 17px; line-height: 24px;">
                                    <p style="margin:0;padding:0;font-family:'Poppins', sans-serif; text-align: center;">
                                        Tailored to your needs by Tradie<span style="display: inline; color: #43D14F;">Flow</span></p>
                                    <p style="margin:0;padding:0;font-family:'Poppins', sans-serif; text-align: center;">
