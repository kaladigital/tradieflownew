            ...
            <div class="row no-gutters">
                <div class="col-12 col-lg-7 col-md-6 content-col">
                    ...
                    <div class="content-section">
                        ...
                        <div class="content-inner">
                            <h1>
                                What is your <span class="green-text">Full Name?</span>
                            </h1>
                ...
                <div class="col-12 col-lg-5 col-md-6 figure-wrap d-flex align-items-center justify-content-center">
                    <div class="figure responsive">
                        <img src="/images/onboarding/figure-step-1.png" alt="Step page figure">
                    </div>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function(){
        $(document).on('submit','#register_step_form',function(){
            ...
            if (name.length) {
                ...
                $.post('/free-trial-2/step/1',{ name: name },function(data){
                    if (data.status) {
                        location.href = '/free-trial-2/step/2';
                    }
                    else{
                        if (data.redirect) {
