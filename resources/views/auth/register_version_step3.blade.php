            ...
            <div class="row no-gutters">
                <div class="col-12 col-lg-7 col-md-6 content-col">
                    ...
                    <div class="content-section">
                        ...
                        <div class="content-inner">
                            <h1>In which <span class="green-text">country do you work?</span></h1>
                            <h6 class="lead-text">
                                In case of trial accounts we can only give you an United States phone number.
                                Later on you will be able to customize your phone number to American, Australian, British and
                                Canadian ones.
                            </h6>
                            <div class="form-wrap form-style2">
                                {!! Form::model($user, ['url' => 'register/v/step/3', 'id' => 'register_step_form']) !!}
                                    ...
                                    <div class="text-center">
                                        <a href="/free-trial-2/step/2" class="go-back">Go Back</a>
                                    </div>
                                {!! Form::close() !!}
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-5 col-md-6 figure-wrap d-flex">
                    <div class="testimonial-wrap text-center mx-auto">
                        <h3>
                            “TradieFlow collects leads from your website and places customer information all into a singular
                            location, all the way to generating reviews and collecting payments.”
                        </h3>
                        <div class="author">
                            <cite>Joe Martin</cite>
                            <span>CEO of PlumbersHome</span>
                        </div>
                    </div>
                    <div class="spacer"></div>
                    <div class="figure responsive">
                        <img src="/images/onboarding/figure-step-3.png" alt="Step page figure">
                    </div>
                </div>
            </div>
        </div>
