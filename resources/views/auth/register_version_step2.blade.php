            ...
            <div class="row no-gutters">
                <div class="col-12 col-lg-7 col-md-6 content-col">
                    ...
                    <div class="content-section">
                        ...
                        <div class="content-inner">
                            <h1>What is the <span class="green-text">name of your Company?</span></h1>
                            <h6 class="lead-text">We will automatically place your company name in documents such as quotes and
                                invoices.</h6>
                            <div class="form-style2 form-wrap">
                                {!! Form::model($user, ['url' => 'register/v/step/2', 'id' => 'register_step_form']) !!}
                                    <div class="form-group">
                                        {!! Form::text('company',null,['id' => 'company', 'class' => 'form-control', 'placeholder' => 'Company Name']) !!}
                                    ...
                                    <div class="text-center">
                                        <a href="/free-trial-2/step/1" class="go-back">Go Back</a>
                                    </div>
                                {!! Form::close() !!}
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-5 col-md-6 figure-wrap d-flex align-items-center justify-content-center">
                    <div class="figure responsive">
                        <img src="/images/onboarding/figure-step-2.png" alt="Step page figure">
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).on('submit','#register_step_form',function(){
            ...
            if (company.length) {
                ...
                $.post('/free-trial-2/step/2',{ company: company },function(data){
                    if (data.status) {
                        location.href = '/free-trial-2/step/3';
                    }
                    else{
                        if (data.redirect) {
